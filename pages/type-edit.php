...
<body>
	...
	<div id="body" style="margin-top:-4px;">
		<div class="header">
			...
			<div style="padding-left:20px;padding-bottom:10px;">
				<label ><font face="century gothic" color="#f3be4b" size="4"><a href="type-maintenance.php?id=<?php echo $_GET['facid'];?>" style="text-decoration:none;"><< Back </a></label></font>
			</div>
		</div>
	...
	<div class="body" style="height:900px;">
		<?php 
			if(isset($_GET['id']) && isset($_GET['facid'])){
				$id = $_GET['id'];
				$facid = $_GET['facid'];
			}else{
				$id = 0;
			...
			$result = mysqli_query($con,"SELECT * FROM tbltype where id=$id and facid=$facid;");
				if(mysqli_num_rows($result)){
					...
					$disc="";
					$imagepath = "";
					header("Refresh:0; url=type-maintenance.php?");
				}
		?>
 		<form method="POST" action="type-upload-edit.php" enctype="multipart/form-data">
			<table class="room">
				<tr>
					<?php echo "<input type=\"hidden\" name=\"typeid\" value=\"".$id."\">" ?>
					...
					<td align="left" style="padding:10px;"><input id="txtcode" name="txtcode" type="text" style="width:600px;" required value="<?php echo $code; ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" style="padding:10px;"><input id="txtremarks" name="txtremarks" type="text" style="width:600px;" required value="<?php echo $remarks; ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" style="padding:10px;"><input id="txtitems" name="txtitems" type="number" style="width:600px;" required value="<?php echo $items; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Price 1:</td>
					<td align="left" style="padding:10px;"><input id="txtprice1" name="txtprice1" step="any" type="number" style="width:600px;" required value="<?php echo $price1; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Price 2:</td>
					<td align="left" style="padding:10px;"><input id="txtprice2" name="txtprice2" step="any" type="number" style="width:600px;" required value="<?php echo $price2; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Price 3:</td>
					<td align="left" style="padding:10px;"><input id="txtprice3" name="txtprice3" step="any" type="number" style="width:600px;" required value="<?php echo $price3; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">per head:</td>
					<td align="left" style="padding:10px;"><input id="txtperhead" name="txtperhead" step="any" type="number" style="width:600px;" required value="<?php echo $perhead; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Number of Persons:</td>
					<td align="left" style="padding:10px;"><input id="txtpax" name="txtpax" step="any" type="number" style="width:600px;" required value="<?php echo $pax; ?>"></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Discount:</td>
					<td align="left" style="padding:10px;"><input id="txtdisc" name="txtdisc" step="any" type="number" style="width:600px;" required value="<?php echo $disc; ?>"></td>
				</tr>
				<tr>
