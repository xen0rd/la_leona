...
$result = mysql_query("SELECT * FROM tblequipmentinventory WHERE flditemcode ='$del' ");
...
<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
	<form action="deleteequip.php?del=<?php echo $del?>" method="post">
...
<br><br><br><br><br>		
	...
	<label > <font face="century gothic" color="grey" size="4">Equipment Name</label></font><input type="text" class="form-control" style="width:50%" disabled name="itemcategory" value="<?php echo $row['flditemname']; ?>"><br><br>
...
<a href="equipinven.php"><input type="button" class="btn btn-default" name="back"  value="No"></a></span>
...
$result = mysql_query("DELETE FROM tblequipmentinventory WHERE flditemcode ='$del' ");

mysql_close($con);
		header("location:equipinven.php?vn=1");
}
?>
<?php
}
