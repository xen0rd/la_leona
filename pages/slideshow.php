...
<body>
    ...
    <div id="body" style="margin-top:-4px;">
        <div style="margin-left:162px;padding:0px;">
            <?php 
                //echo $_SESSION['login_type'];
                if(isset($_SESSION['login_type'])){
                    if($_SESSION['login_type']=="customer"){
                        echo "
                            <a style=\"margin-top:50px;margin-left:50px;font-size:16px;padding:8px;\">Welcome, [".$_SESSION['login_name']."]</a><a href=\"logout.php\" style=\"text-decoration:none;font-size:16px\"> Logout</a>
                        ";
                    }else if($_SESSION['login_type']=="FRONTDESK"){
                        echo "
                    ...
                    echo "
                            <a style=\"margin-top:50px;margin-left:50px;font-size:16px;padding:8px;\"></a><a style=\"text-decoration:none;font-size:16px;\">&nbsp;</a>
                        ";
                    }
                }else{
                    echo "
        ...
        <div class="header" style="margin-top:-16px;">
            <ul>
                ...
                <li>
                    <label ><font face="century gothic" color="#f3be4b" size="4">Gallery slideshow </label></font>
                </li>
            </ul>
            <div style="padding-left:20px;padding-bottom:10px;display:inline-block;">
                <label ><font face="century gothic" color="#f3be4b" size="4">
                    <?php
                        if(isset($_SESSION['login_type'])){
                            if($_SESSION['login_type']=="admin"){
                                echo "<a href=\"gallery-maintenance.php\" style=\"text-decoration:none;\">Edit</a>";
                            }
                        }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 536px; overflow: hidden; visibility: hidden; background-color: #1234e;">
        <!-- Loading Screen -->
        <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
            <div style="position:absolute;display:block;background:url('images/bx_loader.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 800px; height: 456px; overflow: hidden;">
                ...
                if(mysql_num_rows($result)){
                    while($row = mysql_fetch_array($result))
                    {
                        echo "<div data-p=\"144.50\" style=\"display: none;\">
                                ...
                                <img data-u=\"thumb\" src=\"".$row['fname']."\" />
                            </div>";
                    }   
                }
            ?>
            <!--div data-p="144.50" style="display: none;">
                ...
                <img data-u="thumb" src="img2/1.png" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="img2/2.png" />
                <img data-u="thumb" src="img2/2.png" />
            </div>
            <div data-p="144.50" style="display: none;">
