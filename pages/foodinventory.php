...
echo "	<table>
  ...
  <td align='center' ><a href='add.php'><button type='button' class='btn btn-success' name='add'  >Add Supply</button></td> 
	...
	if($red > 0)
	{
        ...
        echo "<a href='inventory.php'><button type='button' name='back' class='btn btn-default'  value='Back'>Close </button>";
		echo "</div>";
...
<th width='45'>Re-Order Point </font></th>
...
while($row = mysql_fetch_array($result))
 ...
 ?><td align='center' width=100  style="<?=status_style($row['fldstatus'])?>"> <?php echo $row['fldstatus']; ?> </td> <?php
  echo "<td align='center'  >" . $row['fldreorderpoint'] . "</td>";
...
?>
 ...
 <td align="center" ><button type='button' class='btn btn-success' onClick="window.location.href='deletesup.php?del=<?php echo $row['flditemcode'];?>'" class='text'>Delete</button></td>
  <td align="center"><button type='button' class='btn btn-success' onClick="window.location.href='update.php?prodcode=<?php echo $row['flditemcode'];?>'" class='text'> Update</button></td>
...
?>
  ...
  <td align="center"  class='tdpos'><button type='button' class="btn btn-success btn-primary" onClick="window.location.href='deletesup.php?del=<?php echo $row['flditemcode'];?>'" class='text'><i class="fa fa-trash"></i>
     ...
     <td align="center"  class='tdpos'><button type='button' class="btn btn-success btn-primary" onClick="window.location.href='update.php?prodcode=<?php echo $row['flditemcode'];?>'" class='text'><i class="fa fa-edit"></i>
	 </button></td>
<?php echo "</tr>";
}
