...
$query = mysql_query("SELECT DISTINCT RegNo, fldfname, fldlname, fldcontact, fldpayment, fldtotal, fldchange FROM tblreport WHERE DATE_FORMAT(fldarrival,'%Y') = '$taess' AND (status = 'Reserved' OR status = 'Checked in')");
		...
		$pdf->setX(120);$pdf->Cell(0,0,'Yearly Sales Report',0,0,'L');
		$pdf->Ln(5);
