...
$displayprofilepic2 = mysql_query("SELECT * from tblphoto WHERE fldtype = 'La Leona Attic'");
	  ...
	  ?>
							...
							<form action="booking_room1.php" method="get">
...
<table class="room">
	<tr>
		...
		?>
			...
			<br> <br><br><br><br><br><h2><font face="century gothic" color="#f3be4b" size="7"> &nbsp; Cabanas</font></h2><hr class="hr"><br><br> 
