...
<body>
	...
	<div id="body" style="margin-top:-4px;">
		<div class="header">
			<ul>
				...
				<li>
					<label ><font face="century gothic" color="#f3be4b" size="4">Amenities - Updating </label></font>
				</li>
			</ul>
	...
	<div class="body" style="height:900px;">
		<?php 
			...
			$result = mysql_query("SELECT * FROM tblamenities where id=$id and facid=$facid;");
		...
		?>
 		<form method="POST" action="amen-upload-edit.php" enctype="multipart/form-data">
			<table class="room">
				<tr>
