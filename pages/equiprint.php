...
/////////////////////////////////////////////////////////////////////////export database to pdf format
	...
	// Adds image to beginning of d
		...
		$query=mysql_query("select * from tblequipmentinventory");
		...
		$pdf->setX(120);$pdf->Cell(0,0,'Equipment Inventory Report',0,0,'L');
		$pdf->Ln(5);
		...
		$pdf->setX(75);$pdf->Cell(0,0,'Item No.',0,0,'L');
		$pdf->setX(127);$pdf->Cell(0,0,'Item Name',0,0,'L');
		$pdf->setX(195);$pdf->Cell(0,0,'Quantity',0,0,'L');
		...
		$pdf->setX(80);$pdf->Cell(0,0,''.$row['flditemcode'],0,0,'L');
		$pdf->setX(130);$pdf->Cell(0,0,''.$row['flditemname'],0,0,'L');
		$pdf->setX(200);$pdf->Cell(0,0,''.$row['fldquantity'],0,0,'L');
