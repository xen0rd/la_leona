...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	mysql_select_db("dbresort", $con);
					...
					{
					$sql="UPDATE tblprice SET fldsession = '$_REQUEST[type]', fldkid= '$_REQUEST[kid]', fldadult = '$_REQUEST[adult]', flda30pax = '$_REQUEST[a30]', fldk30pax = '$_REQUEST[k30]', flda51pax = '$_REQUEST[a51]', fldk51pax = '$_REQUEST[k51]', fldk101pax = '$_REQUEST[k101]', flda101pax = '$_REQUEST[a101]' WHERE fldsession = '$_REQUEST[reg]'";
					mysql_query($sql);
					header("location:manageprices.php");
					}
					else
					{
					header("location:admin_updateprice.php?reg=$_REQUEST[reg]&form=1&type=$_REQUEST[type]&kid=$_REQUEST[kid]&adult=$_REQUEST[adult]&a30=$_REQUEST[a30]&k30=$_REQUEST[k30]&a51=$_REQUEST[a51]&k51=$_REQUEST[k51]&k101=$_REQUEST[k101]&a101=$_REQUEST[a101]&=$tot&add=$add&delete=$delete&conf=1");
					}
...
$res = mysql_query("SELECT * FROM tblprice WHERE fldsession = '$reg'	");
...
?>
<center>
		<div id="white" style="width: 940px; height: 1000px; background-color: white;">
		<div class="row">
                      <div class="col-lg-12">
...
<form action="admin_updateprice.php" method="post">
...
<input type="hidden" name="reg" value="<?php echo $_REQUEST['reg']; ?>">
 ...
 <label > <font face="normal" color="grey" size="4">Session Type</font></label> <input  type="text" readonly class="form-control" style="width:40%" name="type" value="<?php echo $type; ?>"><br>
<label > <font face="normal" color="grey" size="4">Adult Price</font></label> <input type="text"  class="form-control" style="width:40%"  name="adult" value="<?php echo $adult; ?>"> <br>
<label > <font face="normal" color="grey" size="4">Kid Price</font></label> <input type="text"  class="form-control" style="width:40%" name="kid" value="<?php echo $kid; ?>"><br>
<label > <font face="normal" color="grey" size="4">30-50 Pax (Kid Price)</font></label> <input type="text"  class="form-control" style="width:40%" name="a30" value="<?php echo $a30; ?>"><br>
<label > <font face="normal" color="grey" size="4">30-50 Pax (Adult Price)</font></label> <input type="text"  class="form-control" style="width:40%"  name="k30" value="<?php echo $k30; ?>"> <br>
<label > <font face="normal" color="grey" size="4">51-100 Pax (Kid Price)</font></label> <input type="text"  class="form-control" style="width:40%"  name="a51" value="<?php echo $a51; ?>"> 
<label > <font face="normal" color="grey" size="4">51-100 Pax (Adult Price)</font></label> <input type="text"  class="form-control" style="width:40%" name="k51" value="<?php echo $k51; ?>"><br>
<label > <font face="normal" color="grey" size="4">101-150 Pax (Kid Price)</font></label> <input type="text"  class="form-control" style="width:40%"  name="a101" value="<?php echo $a101; ?>"> 
<label > <font face="normal" color="grey" size="4">101-150 Pax (Adult Price)</font></label> <input type="text"  class="form-control" style="width:40%" name="k101" value="<?php echo $k101; ?>"><br>
</span>
