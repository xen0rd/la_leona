...
$code = mysql_real_escape_string($_POST["xcode"]);
		...
		if ($_FILES["file"]["error"] > 0)
			{
				...
				$sql="INSERT into tbltype(facid,code,name,remarks,status,pieces,price1,price2,price3,perhead,pax,disc,image) VALUES($facid,'$code','$name','$remarks','$status','$items','$price1','$price2','$price3','$perhead','$pax','$disc','images/".$_FILES["file"]["name"]."')";
				//$sql="UPDATE tbltype set code ='$code', name ='$name', remarks='$remarks', status ='$status', pieces ='$items', price1 ='$price1', price2 ='$price2', price3 ='$price3', image='images/".$_FILES["file"]["name"]."' where id=$id";
				//echo $sql;
