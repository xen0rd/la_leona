...
<body>
	...
	<div class="body" style="height:900px;">
		...
		?>
 		<form method="POST" action="type-upload-new.php" enctype="multipart/form-data">
			<table class="room">
				<tr>
					...
					<td align="left" style="padding:10px;"><input id="txtcode" name="txtcode" type="text" style="width:600px;" disabled required value="<?php echo $newcode;?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" style="padding:10px;"><input id="txtperhead" name="txtperhead" step="any" type="number" style="width:600px;" required></td>
				</tr>
				<tr>
					<td align="right" style="padding:10px;">Number of Persons:</td>
					<td align="left" style="padding:10px;"><input id="txtpax" name="txtpax" step="any" type="number" style="width:600px;" required></td>
				</tr>
				<tr>
