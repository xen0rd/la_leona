...
$displayprofilepic2 = mysql_query("SELECT * from tblphoto WHERE fldtype = 'La Leona Attic'");
	  ...
	  ?>
	<form action="walkin_cabana1.php" method="get">
...
<table class="room">
	<tr>
		...
		<br> <br><br><br><br><br><hr class="hr"><br><br> 

		<img src="img2/le leona cabana.png" alt="Note" style="height:200px;width:250px">
		<span id="tab"> <br><br><font face="century gothic" color="#f3be4b" size="5">La Leona Cabana </font><br> 25 pax</span>
		<span id="tab">Day use <br><br> Php 1200 </span>
		...
		<?php
							...
							?>
			<input class="form-control" type="hidden" name="extra" value="<?php echo $_REQUEST['extra']; ?>">
		...
		?>
			...
			<br> <br><br><br> <h2><font face="century gothic" color="#f3be4b" size="7"> &nbsp; &nbsp;  Rooms</font></h2><hr class="hr"><br><br> 
