		...
		<div class="body" style="align:center;height:790px;">
			...
			<div style="margin-left:0px;margin-top:-80px;">
				...
				<?php
					...
					$xpax=$_SESSION['xpax'];
					$numpax=$_SESSION['numpax'];
					$xcs=$_SESSION['xcs'];
					$xcsamt=$_SESSION['xcsamt'];
					$per=$_SESSION['per'];
					if($facid==3){
						$totime=$_SESSION['totime'];
						$addhrs=$_SESSION['addhrs'];
						$addhrsamt=$_SESSION['addhrsamt'];
						$occasion=$_SESSION['occasion'];
						$cater=$_SESSION['cater'];
						$tin=$_SESSION['tin'];
						$tout=$_SESSION['tout'];
					}else{
						$cout=$_SESSION['cout'];
					...
					echo "<input type=\"hidden\" name=\"id\" value=\"$facid\">";
					echo "<input type=\"hidden\" name=\"fac\" value=\"$faci\">";
					echo "<input type=\"hidden\" name=\"use\" value=\"$use\">";
					echo "<input type=\"hidden\" name=\"rate\" value=\"$rate\">";
					echo "<input type=\"hidden\" name=\"bedx\" value=\"$bedx\">";
					echo "<input type=\"hidden\" name=\"numpax\" value=\"$numpax\">";
					echo "<input type=\"hidden\" name=\"xcs\" value=\"$xcs\">";
					echo "<input type=\"hidden\" name=\"xcsamt\" value=\"$xcsamt\">";
					echo "<input type=\"hidden\" name=\"per\" value=\"$per\">";
					echo "<input type=\"hidden\" name=\"cin\" value=\"$cin\">";
					echo "<input type=\"hidden\" name=\"cout\" value=\"$cout\">";
					echo "<input type=\"hidden\" name=\"occa\" value=\"$occasion\">";
					echo "<input type=\"hidden\" name=\"cater\" value=\"$cater\">";
					echo "<input type=\"hidden\" name=\"tin\" value=\"$tin\">";
					echo "<input type=\"hidden\" name=\"tout\" value=\"$tout\">";
					echo "<input type=\"hidden\" name=\"totime\" value=\"$totime\">";
					echo "<input type=\"hidden\" name=\"addhrs\" value=\"$addhrs\">";
					echo "<input type=\"hidden\" name=\"addhrsamt\" value=\"$addhrsamt\">";
					echo "<input type=\"hidden\" name=\"days\" value=\"$days\">";
					echo "<input type=\"hidden\" name=\"totamt\" value=\"$totamt\">";
					...
					<table class="room" style="margin-left:50px;margin-right:50px;width:800px;" border="0" cellpadding="5">
						...
						<tr><td align="right" colspan="4"><button type="submit">Save & Reserved</button></td></tr>
					</table>
				</form>
				<?php
					//echo $_SESSION['faci'];
