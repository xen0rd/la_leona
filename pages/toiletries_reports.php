	...
	<div id="body">
		...
		<div class="header">
			...
			<ul>
				...
				<li>
			<label > <font face="century gothic" color="#f3be4b" size="5">Toiletries Reports  </label></font>
				</li>
				<li>
...
echo "</th>";
echo "</tr> ";
echo "<button input  class='btn btn-success'style='margin-left:-840px; type='button' > <a target = '_blank' href='toiletriesprint.php' style='text-decoration:none;'>  Print a copy </button></a></span>";
echo "</th>";
echo "</tr> ";
...
$result = mysql_query("SELECT * FROM tbltoiletries");
