...
$query = mysql_query("SELECT DISTINCT RegNo, fldfname, fldlname, fldcontact, fldpayment, fldtotal FROM tblreportsevent WHERE DATE_FORMAT(fldarrival,'%Y') = '$taess' AND (status = 'Reserved' OR status = 'Checked in')");
