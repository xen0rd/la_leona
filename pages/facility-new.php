 		...
 		<form method="POST" action="file_upload.php" enctype="multipart/form-data">
			<table class="room">
				<tr>
					...
					<td align="left" style="padding:10px;"><textarea id="txtdes" name="txtdes" style="height:100px;width:600px;resize:none;" required></textarea></td>
				<tr>
				</tr>
					<td align="right" style="padding:10px;">Image:</td>
