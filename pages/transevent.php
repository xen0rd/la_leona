...
/////////////////////////////////////////////////////////////////////////export database to pdf format
	...
	// Adds image to beginning of d
		...
		$query=mysql_query("select DISTINCT RegNo, fldlname, fldfname, fldtotal, fldpayment from tblreportsevent WHERE (status = 'Reserved' OR status = 'Checked in')");
		...
		$pdf->setX(120);$pdf->Cell(0,0,'Event Hall Sales Report',0,0,'L');
		$pdf->Ln(5);
