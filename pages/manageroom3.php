	...
	<div id="body">
		...
		<div class="header">
			<ul>
				...
				<li>
			<label > <font face="century gothic" color="#f3be4b" size="4"> Update Cabana and Hut Categories</label></font>
				</li>
				<li>
...
echo "<td> <center>";
echo "<form action='manageroom3.php' method='post'>";
...
<th width='200'>Cabana/ Hut Type</th>
<th width='200'>Day Price </th>
<th width='200'>Night Price </th>
<th width='200'>Day and Night Price </th>
...
while($row = mysql_fetch_array($result))
  { 
	 ...
	 echo "<td align='center'   class='tdpos'>" . $row['fldnight' ] ."</td>";
	  echo "<td align='center'   class='tdpos'>" . $row['fldovernight' ] ."</td>";
...
?>
	 ...
	 <td align="center"> <button type='button' onclick="window.location.href='admin_updatehut.php?reg=<?php echo $row['fldtype'];?>'"  class="btn btn-info"><i class="fa fa-edit"></i></button></td>
	<td align="center"><button type='button' onclick="window.location.href='managehut.php?reg=<?php echo $row['fldtype'];?>'" class="btn btn-danger"><i class="fa fa-edit"></i> </button></td>	
