        ...
        while($row = mysql_fetch_array($result))
          {
            ...
            echo '<td><a href="room101.php?id='.$row['fldroomnumber'].'"><button type="button" class="btn btn-success"><i class="fa fa-reply"></i> View Item</button></a> <a href="addroom1.php?id='.$row['fldroomnumber'].'&roomno='.$row['fldroomname'].'"><button type="button" class="btn btn-danger"><i class="fa fa-plus"></i> Add Item</button></a></td>';
			echo '</tbody>';
            echo '</tr>';
          }
        ?>
