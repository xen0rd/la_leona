...
$query = mysql_query("SELECT DISTINCT RegNo, fldfname, fldlname, fldcontact, fldpayment, fldtotal FROM tblreport WHERE DATE_FORMAT(fldarrival,'%m-%Y') = '$taes-$taess' AND (status = 'Reserved'  OR  status = 'Checked in')");
