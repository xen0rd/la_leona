...
/////////////////////////////////////////////////////////////////////////export database to pdf format
	...
	// Adds image to beginning of d
		...
		$pdf->setX(17);$pdf->Cell(0,0,'List of Checked-in Summary',0,0,'L');
		$pdf->Ln(10);
		...
		$query=mysql_query("select * from tblreservations WHERE status='checkedin' AND cin>='$datein' AND cout<'$dateout'");
