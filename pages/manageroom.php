	...
	<div id="body">
		...
		<div class="header">
			<ul>
				...
				<li>
			<label > <font face="century gothic" color="#f3be4b" size="4"> Upload Picture </label></font>
				</li>
				<li>
...
<center>
		<div id="white" style="width: 940px; height: 660px; background-color: white;">
		<div class="row">
                      <div class="col-lg-12">
		...
		<tr>
              ...
              <br>
	                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<?php $reg= $_REQUEST['reg']; ?>
						<Br><br><Br>
						Room Type: 
						<br>
							
									  <input type="hidden"value="<?php echo $reg?>"><?php echo $reg?></input>
									...
									<?php
										...
										$displayprofilepic = mysql_query("SELECT * from tblphoto WHERE fldtype = '$reg'");
										while($profile = mysql_fetch_array($displayprofilepic))
										{
										$imagefilename = $profile['imagefile'];
										}

										$displayroom = mysql_query("SELECT DISTINCT * FROM tblroom WHERE fldtype = '$reg' ");
									...
									?>
													...
													<br><br>
															...
															<span class="profile-picture">
																<img width="320px" height="250px" alt="Room Image" id="roomimage" src="../uploadedpicture/<?php echo $imagefilename;?>">
															</span>
						...
						<input type="hidden" name="roomtype" value="<?php echo $reg;?>">
						<p><input class="btn btn-primary" type="submit" name="btn_upload" value="Upload"></p><a href="manageroom2.php"><input type="button" name="back"value="Back"></a>
