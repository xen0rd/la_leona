		...
		<div class="navigation">
			<ul>
				...
				<li>
					...
					<li>
					<a href="price_hall.php">Function Hall Price</a>
					</li>
					</ul>
				<li class="booking">
...
$date = date("Y-m-d");
	...
	$result = mysql_query("SELECT * FROM tblhall");

echo "</td>";
echo "<tr> ";
echo "<table>  
<h2>Function Hall Rate</h2>
<tr bgcolor='green'>

<th width=200><font color='white'>Room Type </font></th>
<th width=200><font color='white'>50 - 100 persons </font></th>
<th width=200><font color='white'>150 - 200 person </font></th>
<th width=100></th>
<th width=200></th>
</tr> ";
...
{ 
	 ...
	 echo "<td align='center' width=200  class='tdpos'>" . $row['fld50pax'] . "</td>";
	 echo "<td align='center' width=200  class='tdpos'>" . $row['fld100pax'] . "</td>";
