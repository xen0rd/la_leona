...
?>		
<form action="payment_ok1.php" method="post">
			...
			<?php ///// ROOMS ?>	
						...
						<button > <a target = "_blank" href="receipt.php?reg=<?php echo $reg;?>&fname=<?php echo $fname; ?>&lname=<?php echo $lname; ?>&contact=<?php echo $contact; ?>&checkin=<?php echo $checkin;?>&time=<?php echo $time;?>&types=<?php echo $types;?>&adult=<?php echo $adult;?>&child=<?php echo $child;?> 
