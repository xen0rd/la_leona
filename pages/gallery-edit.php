...
<body>
	...
	<div class="body_" style="text-align:center;height:940px;">
		...
		<form method="POST" action="gallery-upload-edit.php" enctype="multipart/form-data">
			<?php
			//echo "<tr>";
				if(isset($_GET['id'])){
					$id=$_GET['id'];
				...
				if(mysql_num_rows($result)){
					...
					{	
						...
						echo "<div style=\"margin-left:170px;margin-top:-50px;text-align:left;\"><p>Description:</p><input type=\"text\" name=\"txtdesc\" id=\"txtdesc\" style=\"width:600px;\" value=\"".$row['description']."\"></div>";
						echo "<div style=\"margin-left:170px;margin-top:20px;text-align:left;\"><p>Upload:</p><input type=\"file\" name=\"file\" id=\"file\"></div>";
