		...
		<tr>
              ...
              <br>
	                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<form action="managehut.php" method="post">
						...
						<br>
									...
									<?php
										...
										$displayroom = mysql_query("SELECT DISTINCT * FROM tblhut WHERE fldtype = '$reg' ");
									...
									?>
											...
											<div id="supplies" class="tab-pane <?php if($activeequiptab==0) {?> in active <?php }?>">
													<div class="row">
														...
														<form enctype="multipart/form-data" action="uploadphoto1.php" method="post" onsubmit="return Validate(this);">
						...
						<p><input class="btn btn-primary" type="submit" name="btn_upload" value="Upload"></p><a href="manageroom3.php"><input type="button" name="back"value="Back"></a>
