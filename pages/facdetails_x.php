			...
			<center>
				...
				echo "</form>";
					...
					if(isset($_SESSION['reserve'])){
						...
						<span>
							&nbsp;Additional Hours: &nbsp;<input id=\"txtAddHrs\" name=\"addhrs\" type=\"text\" size=\"2\" style=\"width:70px;\" value=\"".$_SESSION['addhrs']."\">&nbsp;
						</span>
						<br /><br /><br />
						<span>
					...
					<span>
						&nbsp;Additional Hours: &nbsp;<input id=\"txtAddHrs\" name=\"addhrs\" type=\"text\" size=\"2\" style=\"width:70px;\">&nbsp;
					</span>
					<br /><br /><br />
					<span>
