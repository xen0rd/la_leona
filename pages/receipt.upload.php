...
<body>
	...
	<div id="body" style="margin-top:-4px;">
		<div class="body" style="align:center;height:790px;">
			...
			echo "<div style=\"margin-top:-100px;margin-left:-80px;\">";
				if(isset($_GET["id"])){
					...
					echo "<p style=\"font-size:14px;padding:0px;margin-top:-12px;\">Rate of excess person: PHP <span style=\"color:red;\">". $per." </span></p><br />";
					echo "<input type=\"hidden\" name=\"hper\" id=\"hper\" value=\"".$per."\">";
					echo "<p style=\"font-size:14px;padding:0px;margin-top:-12px;\">No. of Persons <span style=\"color:red;\">". $numpax." </span>Max(".$xpax.") Excess(<span style=\"color:red;\">".$xcs."</span>)<br />";
					echo " Amount of Excess Person: PHP(<span style=\"color:red;\">".$xcs_amt."</span>)</p><br />";
					...
					elseif ($days>1) {
						echo "<p style=\"font-size:14px;padding:0px;margin-top:-12px;\">The total number of days <span style=\"color:red;\">" . $days . " days </span></p><br />";
					}else{
		...
		<?php 
			...
			$result = mysqli_query($con, "SELECT * FROM tblreservations where trxnid=$id");
 ...
 <a href =" <?php echo $imagepath; ?>" width="500px" height="500px" target="_blank" style=" text-decoration:none;" ><button style=" position: relative; top: 210px;  left: 245px;" > View image</button></a>
 		...
 		<form method="POST" action="upload-edit.php" enctype="multipart/form-data">
				...
				<div style="margin-left:200px;margin-top:-50px;width:900px;">
